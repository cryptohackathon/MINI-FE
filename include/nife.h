...
int write_ciphertextwproofs_to_file (element_t CT,
				     ChaumPedersenProof
				     Proof[RANGE_OF_GRADING], char *filename);
int write_ciphertext_to_file (element_t CT, char *filename);
int read_ciphertextwproofs_from_file (element_t CT,
				      ChaumPedersenProof
				      Proof[RANGE_OF_GRADING],
				      char *filename);
